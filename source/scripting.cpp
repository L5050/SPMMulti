...
s32 npcGetPlayerVelocity(spm::evtmgr::EvtEntry * evtEntry, bool firstRun) {
  ...
  s32 evt_npc_entry_autoname(spm::evtmgr::EvtEntry * evtEntry, bool firstRun) {
    ...
    const char * animpose = (const char*)spm::evtmgr_cmd::evtGetValue(evtEntry, args[0]);
    spm::npcdrv::NPCEntry* entry = spm::npcdrv::npcEntry(name, animpose, args[1], 0);
    spm::evtmgr_cmd::evtSetValue(evtEntry, args[2], (s32)entry->name);
    return 2;
  }
...
EVT_BEGIN(spawnThunderCloud)
    USER_FUNC(evt_npc_entry_autoname, PTR("e_kmoon"), 0, LW(14))
    USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(1), LW(2), LW(3))
    ADD(LW(2), 50)
    USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(14), LW(1), LW(2), LW(3))
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(14), 1, true)
    RUN_EVT(thunderCloud)
RETURN()
EVT_END()
...
EVT_BEGIN(thunderCloud)
    ...
    DO(150)
      ...
      WAIT_FRM(1)
    WHILE()
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(14), 5, true)
    USER_FUNC(spm::evt_snd::evt_snd_sfxon_npc, PTR("SFX_I_BIRIBIRI1"), LW(14))
    DO(30)
      USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(1), LW(2), LW(3))
      ADD(LW(2), 50)
      USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(14), LW(1), LW(2), LW(3))
    ...
    DO(30)
      ...
      WAIT_FRM(1)
    WHILE()
    USER_FUNC(spm::evt_npc::evt_npc_set_anim, LW(14), 2, true)
    DO(180)
      USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(1), LW(2), LW(3))
      ADD(LW(2), 50)
      USER_FUNC(spm::evt_npc::evt_npc_set_position, LW(14), LW(1), LW(2), LW(3))
    ...
    USER_FUNC(spm::evt_mario::evt_mario_get_pos, LW(1), LW(2), LW(3))
    USER_FUNC(spm::evt_snd::evt_snd_sfxon_npc, PTR("SFX_I_THUNDER1"), LW(14))
    ...
    USER_FUNC(spm::evt_npc::evt_npc_get_position, LW(14), LW(0), LW(1), LW(2))
    USER_FUNC(spm::evt_eff::evt_eff, 0, PTR("dmen_warp"), 0, LW(0), LW(1), LW(2), 0, 0, 0, 0, 0, 0, 0, 0)
    USER_FUNC(spm::evt_snd::evt_snd_sfxon_3d, PTR("SFX_BS_DMN_GOOUT1"), LW(0), LW(1), LW(2))
